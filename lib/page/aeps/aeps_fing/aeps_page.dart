...
class AepsFingPage extends GetView<AepsFingController> {
  const AepsFingPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(AepsFingController());
          ...
          Form(
            ...
            child: Column(
              children: [
                ...
                Obx(() => (controller.aepsTransactionType.value == AepsTransactionType.cashWithdrawal)
                    ? Card(
                        child: Padding(
                          padding: const EdgeInsets.only(
                              top: 16, bottom: 16, right: 16, left: 16),
