...
class UpiReportController extends GetxController with ReceiptPrintMixin {
  ...
  UpiReportController( this.origin);
  ...
  fetchSummaryReport() async {
    ReportSummaryType type = ReportSummaryType.upi;
  ...
  fetchReport() async {
    ...
    try {
      ...
      final response =  await repo.fetchUPITransactionList(_param());
  ...
  void requeryTransaction(MoneyReport report) async {
    try {
      ...
      var response =  await repo.requeryUPITransaction({
